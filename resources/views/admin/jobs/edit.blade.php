                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                      ...
                                      <div class="col-md-6">
                                      <div class="form-group">
                                  <input type="text" placeholder="Enter Job Id" name="industry_id"  value="{{$job->industry->name}}" class="form-control @error('industry_id') is-invalid @enderror" id="exampleInputEmail1" list="cityname">
                                  <small id="emailHelp" class="form-text text-muted">Enter Job Id
                                  </small>
                                  <datalist id="cityname">
                                           @forelse ($industries as $ind)
                                            <option value="{{$ind->name}}" @if($ind->id == $job->industries_id) selected @endif> {{$ind->name}} </option>
                                            @empty
                                            @endforelse
                                            @error('industry_id')
                                            <span class="invalid-feedback"> <small> *</small> </span>
