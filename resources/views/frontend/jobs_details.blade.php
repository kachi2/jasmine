                                    ...
                                    <div class="col-md-12 p-3 mb-3" style="border: 1px solid #b2b2b260; border-radius:10px">
                                        <div class="discover-item">
                                            ...
                                            <div class="discover-item__info">
                                               ...
                                               <hr>
                                               <span> {!! substr($jo->job_details,0,120) !!} </span>
                                                   <a style="display:inline" href="{{route('job-details', $jo->id.'-'.str_replace(' ','',$jo->title))}}"> readmore </a> <br> <a href="{{route('job-details', $jo->id.'-'.str_replace(' ','',$jo->title))}}" class=" btn-primary btn-sm"> Apply for this Job</a>
                                            </div>
