...
Route::get('/job/ourteam/{id}',  [ClientJobController::class, 'TeamRequestJoin'])->name('job-applies');
// Route::get('/join/jasmines/{id}',  [ClientJobController::class, 'JoinOurTeam'])->name('joinJasmine');
